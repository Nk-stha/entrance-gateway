...
export function CollegeContactMobile({ contactInfo }: CollegeContactMobileProps) {
  return (
    <section className="lg:hidden bg-white rounded-2xl p-6 shadow-sm border border-gray-200">
      ...
      <div className="space-y-4 text-sm">
        {contactInfo.website && (
          <a
            ...
            className="flex items-center gap-3 text-gray-600 hover:text-brand-blue transition-colors"
          >
